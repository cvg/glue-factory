...
from gluefactory.visualization.viz2d import plot_images, plot_keypoints, plot_lines, save_plot
import os
    
if os.path.exists('./match_score'):
    os.system('rm -r ./match_score')
os.mkdir('./match_score')
