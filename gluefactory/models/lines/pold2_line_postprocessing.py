...
class LineExtractor():
    ...
    def three_stage_filter(self, points,distance_map, binary_distance_map, angle_map, indices_image):
        ...
        indices_image = self.filter_with_distance_field(
            points, binary_distance_map,distance_map, indices_image, self.coeffs_strong, self.coeffs_strong_second, self.num_sample_strong, ratio_inliner=0.98, mean_value_ratio=0.8)
    ...
    def post_processing_step(self, points, distance_map, angle_map):
        ...
        return self.three_stage_filter(points, distance_map,binary_distance_map, angle_map, indices_image)
